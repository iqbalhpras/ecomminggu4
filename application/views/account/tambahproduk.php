    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo site_url("dashboard/tambahproduk");?>" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Tambah Barang                
              </p>
          ...
          <li class="nav-item">
            <a href="<?php echo site_url("dashboard/kategori");?>" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Daftar kategori                
              </p>
          ...
          <div class="col-md-12">           
            ...
            <div class="card">
              ...
              <div class="card-body p-0">                
                <!-- /.table-responsive -->
                <?php echo form_open_multipart('Dashboard/addproduk');?>
                      ...
                      <div class="form-group">
                          <input type="text" name="deskripsi" class="form-control" placeholder="deskripsi" required="required">
                      ...
                      <div class="form-group">
                          ...
                          <p> <?php echo form_error('gambar'); ?> </p>
                      </div>
                      ...
                      <div class="form-group">
                          <button type="submit" class="btn btn-primary btn-block" value="Tambah">Tambah</button>
                      </div>              
                  <?php echo form_close();?>   
              </div>
              <!-- /.card-body -->              
